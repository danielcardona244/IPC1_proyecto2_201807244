...
exports.cargarEstudiantes = (req, res) => {
    ...
    res.json({ message: 'Estudiantes cargados correctamente', estudiantes }); // Enviar los estudiantes cargados
};
...
// Obtener la lista de estudiantes cargados
exports.obtenerEstudiantes = (req, res) => {
    res.json(estudiantes); // Devolver el array de estudiantes cargados
};
